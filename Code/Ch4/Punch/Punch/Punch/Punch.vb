...
#Region "Private variables"
  ...
  Private Shared P_IN As Boolean = False
  Private Shared P_OUT As Boolean = True
  Private mPunchState As Boolean = P_IN

  Private mStartPunch As DateTime
  Private mEndPunch As DateTime

  Private MyPunches As ArrayList = New ArrayList()
...
#End Region
  ...
  Private Sub Punch_Load(ByVal sender As System.Object, _
  ...
  Private Sub cmdPunch_Click(ByVal sender As System.Object, _
  ...
  Private Sub cmbWeek_SelectedIndexChanged(ByVal sender As System.Object, _
                                           ByVal e As System.EventArgs) _
